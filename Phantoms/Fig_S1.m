...
[Rsquared1]=plot_mdl_synth([T1woverPDw_sym_FA1; R1_sym], color(1,:),1);
[Rsquared2]=plot_mdl_synth([T1woverPDw_sym_FA2; R1_sym], color(2,:),1);
[Rsquared3]=plot_mdl_synth([T1woverPDw_sym_FA3; R1_sym], color(3,:),1);
...
subplot(1,3,2);
hold on;
[Rsquared1]=plot_mdl_synth([T1woverPDw_sym_TR3; R1_sym], color(1,:),1);
[Rsquared2]=plot_mdl_synth([T1woverPDw_sym_TR2; R1_sym], color(2,:),1);
[Rsquared3]=plot_mdl_synth([T1woverPDw_sym_TR1; R1_sym], color(3,:),1);
xlabel('synthetic T1w/PDw [a.u.]','FontSize',fontsize); 
ylabel('synthetic R1 [S^-^1]','FontSize',fontsize);
axis tight
...
subplot(1,3,3);
hold on;
[Rsquared1]=plot_mdl_synth([lnT2woverPDw_sym_TE3; R2_sym], color(1,:),1);
[Rsquared2]=plot_mdl_synth([lnT2woverPDw_sym_TE2; R2_sym], color(2,:),1);
[Rsquared3]=plot_mdl_synth([lnT2woverPDw_sym_TE1; R2_sym], color(3,:),1);
