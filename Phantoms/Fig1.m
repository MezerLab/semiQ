...
[Rsquared1]=plot_mdl_synth([T1_noisy3; R1_sym], color(1,:),0);
[Rsquared2]=plot_mdl_synth([T1_noisy2; R1_sym], color(2,:),0);
[Rsquared3]=plot_mdl_synth([T1_noisy1; R1_sym], color(3,:),0);
[Rsquared4]=plot_mdl_synth([T1woverPDw_sym; R1_sym], color(4,:),1);
...
hold on;
[Rsquared5]=plot_mdl_synth([T2_noisy3; R2_sym], color(1,:),0);
[Rsquared6]=plot_mdl_synth([T2_noisy2; R2_sym], color(2,:),0);
[Rsquared7]=plot_mdl_synth([T2_noisy1; R2_sym], color(3,:),0);
[Rsquared8]=plot_mdl_synth([lnT2woverPDw_sym; R2_sym], color(4,:),1);
